...
WorkFile = '../Model/o3_surface_20180701000000.nc'; % un rem this line to see what happens with good data
...
% append, use 'a'
LogID = fopen('AnalysisLog.txt', 'a'); % To be with 'w' when it has to clear the previous LogFile
