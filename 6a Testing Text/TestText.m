...
%% Test a good file
%% Set file to test
WorkFile = 'C:\Program Files\MATLAB\R2021a\bin\o3_surface_20180701000000.nc'; % define our test file

Contents = ncinfo(WorkFile); % Store the file content information in a variable.
FileID = netcdf.open(WorkFile,'NC_NOWRITE'); % open file read only and create handle
...
%% Set file to test
    WorkFile = 'C:\Program Files\MATLAB\R2021a\bin\TestyTest.nc'; % define our test file
